    ...
    if(curr_workshops.length == 0) {
        curr_workshops.push(
            <div key={-1} className="w-screen h-80 bg-faded-blue mx-auto flex justify-center">
                <h1 className="my-auto text-lg md:text-3xl text-white font-bold">Currently, we have no competitions available. Please contact us to learn more about future events.</h1>
            </div>
        )
    }
    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center justify-center pt-60">
                <h1 className="text-4xl font-bold mb-4 text-center">Competitions</h1>
                <p className="text-lg text-center">Explore our competitions!</p>
            </div>
            <div className="flex flex-col items-center mx-auto mt-8 min-h-screen">
                ...
                <h1 className="text-4xl font-bold my-4 text-center">Past Competitions</h1>
